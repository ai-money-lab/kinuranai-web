...
### 1-5. ⚠️ LINE プラン選択 (broadcast コスト試算)

`api/cron-daily-broadcast.js` は毎朝 7:00 全友だちへ broadcast 配信する。
LINE 公式アカウントは月間配信数で課金:

| プラン | 月額 | 無料配信数/月 | 友だち300人時の月配信数 | 適合性 |
|---|---:|---:|---:|---|
| コミュニケーション | 0円 | 200通 | 9,000通 (超過) | **不適** |
| ライト | 5,000円 | 5,000通 | 9,000通 (超過) | 過渡期 |
| **スタンダード** | **15,000円** | **30,000通** | 9,000通 (余裕) | **推奨** |

**Phase A (登録300人以下) はライトプラン (¥5,000/月)** + 一部 broadcast を絞る運用が最安。
登録1,000人超でスタンダードへ移行。**この費用は試算 ¥118,800/月 から差引が必要**。
